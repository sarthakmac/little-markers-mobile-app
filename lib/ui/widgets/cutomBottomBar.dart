...
class CustomBottomNavigationBar extends StatefulWidget {
  ...
  /// [items]s, have [CustomBottomNavigationBarItem.backgroundColor] set, the [item]'s
  ...
  // Used by the [CustomBottomNavigationBar] constructor to set the [type] parameter.
  //
  // If type is provided, it is returned. Otherwise,
  // [CustomBottomNavigationBarType.fixed] is used for 3 or fewer items, and
  // [CustomBottomNavigationBarType.shifting] is used for 4+ items.
  static CustomBottomNavigationBarType _type(
      CustomBottomNavigationBarType type,
    ...
    return items.length <= 3 ? CustomBottomNavigationBarType.fixed : CustomBottomNavigationBarType.shifting;
  }

  // Used by the [CustomBottomNavigationBar] constructor to set the [showUnselected]
  // parameter.
  //
  ...
  static bool _defaultShowUnselected(CustomBottomNavigationBarType type) {
    switch (type) {
